...
//  {InstrOpCode::OP_IMM, OpImmFunctionCodes::SRAI,  SRAI},
    {InstrOpCode::BRANCH, BranchFunctionCodes::BEQ,  BEQ},
    {InstrOpCode::BRANCH, BranchFunctionCodes::BNE,  BNE},
    {InstrOpCode::BRANCH, BranchFunctionCodes::BLT,  BLT},
    {InstrOpCode::BRANCH, BranchFunctionCodes::BLTU, BLTU},
    {InstrOpCode::BRANCH, BranchFunctionCodes::BGE,  BGE},
    {InstrOpCode::BRANCH, BranchFunctionCodes::BGEU, BGEU},
